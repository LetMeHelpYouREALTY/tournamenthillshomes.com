...
export const DOMAIN_CONFIGS: Record<string, DomainConfig> = {
  ...
  "tournamenthillshomes.com": {
    domain: "tournamenthillshomes.com",
    ...
    keywords: [
      ...
      "Tournament Hills Las Vegas map",
    ...
    pageType: "luxury",
    realscoutAgentId: REALSCOUT_AGENT_ID,
    ctaBadge: "Tournament Hills Expert",
    ctaHeadline: "Find Your Tournament Hills Home",
    ctaSubheadline:
      "I know every listing in Tournament Hills — guard-gated golf living with Strip and mountain views.",
  },
...
export const DEFAULT_CONFIG: DomainConfig = {
  ...
  ctaHeadline: "Find Your Las Vegas Home",
  ctaSubheadline:
    "Call or text Dr. Jan at (702) 500-1942 — I answer my own phone.",
};
